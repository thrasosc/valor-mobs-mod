...
public class AztecWarriorAnimator extends AzEntityAnimator<AztecWarrior> {
  private static final ResourceLocation ANIMATIONS =
      ResourceLocation.fromNamespaceAndPath(
          ValorMobs.MOD_ID, "animations/entity/aztec_warrior.animation.json");
    ...
    azAnimationControllerContainer.add(
        AzAnimationController.builder(this, "base_controller")
            .setKeyframeCallbacks(
                AzKeyframeCallbacks.<AztecWarrior>builder()
  ...
  @Override
  public @NotNull ResourceLocation getAnimationLocation(AztecWarrior aztecWarrior) {
    return ANIMATIONS;
  }
}

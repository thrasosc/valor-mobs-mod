...
public class EntityTypeRegistry {
  ...
  public static final EntityType<SeaSerpent> SEA_SERPENT =
      register(SeaSerpent::new, "sea_serpent", 3.0F, 1.0F);
  ...
  public static void init() {
    ...
    FabricDefaultAttributeRegistry.register(SEA_SERPENT, SeaSerpent.createAttributes());
  }
}
